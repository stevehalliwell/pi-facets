...
3. Inspect ownership. Compare each directive against canonical resource home and, for facets, hard role/authority/style boundaries. Permit short named references. Collect exact excerpt or location for each possible finding. Done when findings have evidence.
...
- Preserve short cross-references; flag duplication only when ownership or repeated context cost is evidenced.
