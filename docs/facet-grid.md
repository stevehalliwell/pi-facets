...
- Presets: `technical-review`, `implementation-partner`, `web-implementation`, `backlog-capture`, `backlog-refinement`, `messaging-strategy`, `editorial-review`, `ghostwriter`, `five-whys`, `visual-direction`, `research-exploration`, `delivery-planning`, `release-readiness`.
